...
const EmployeeForm = ({ employee }: EmployeeProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try{
            const response = await axios.patch(`/api/employee/${employee.id}`, values);
  ...
  return (
    <div className=" max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6 mt-16">
      <div>
        ...
        <p className="text-sm text-slate-400">Edit info about emploee!</p>
        <Form {...form}>
            <form
